package com.example.netty_learning.chapter17_InitiationAndNotification.protocol;
...
import com.example.netty_learning.chapter17_InitiationAndNotification.protocol.request.LoginRequestPacket;
import com.example.netty_learning.chapter17_InitiationAndNotification.protocol.request.LogoutRequestPacket;
import com.example.netty_learning.chapter17_InitiationAndNotification.protocol.request.MessageRequestPacket;
import com.example.netty_learning.chapter17_InitiationAndNotification.protocol.response.CreateGroupResponsePacket;
import com.example.netty_learning.chapter17_InitiationAndNotification.protocol.response.LoginResponsePacket;
import com.example.netty_learning.chapter17_InitiationAndNotification.protocol.response.LogoutResponsePacket;
import com.example.netty_learning.chapter17_InitiationAndNotification.protocol.response.MessageResponsePacket;
import com.example.netty_learning.chapter17_InitiationAndNotification.serialize.Serializer;
import com.example.netty_learning.chapter17_InitiationAndNotification.serialize.impl.JSONSerializer;
