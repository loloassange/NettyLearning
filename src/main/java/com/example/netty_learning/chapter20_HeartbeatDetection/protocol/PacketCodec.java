package com.example.netty_learning.chapter20_HeartbeatDetection.protocol;

import com.example.netty_learning.chapter20_HeartbeatDetection.Constent;
import com.example.netty_learning.chapter20_HeartbeatDetection.protocol.request.*;
import com.example.netty_learning.chapter20_HeartbeatDetection.protocol.response.*;
import com.example.netty_learning.chapter20_HeartbeatDetection.serialize.Serializer;
import com.example.netty_learning.chapter20_HeartbeatDetection.serialize.impl.JSONSerializer;
...
public class PacketCodec {
    ...
    private PacketCodec() {
        ...
        packetTypeMap.put(Constent.JOIN_GROUP_REQUEST, JoinGroupRequestPacket.class);
        packetTypeMap.put(Constent.JOIN_GROUP_RESPONSE, JoinGroupResponsePacket.class);
        packetTypeMap.put(Constent.QUIT_GROUP_REQUEST, QuitGroupRequestPacket.class);
